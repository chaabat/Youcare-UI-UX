                ...
                <>
                  ...
                  {userRole === "organizer" && ( // Show these links for organizer user
                      <>
                          ...
                          <Link to="/annonces" className="font-mono font-bold text-m text-white  ">Annonces</Link>
                          <Link to="/Apps" className="font-mono font-bold text-m text-white  ">applications</Link>
                          
                          <Link to="/signin">
                              <svg className="w-7 h-7 text-white hover:text-red-600 duration-500 ml-16" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  ...
                  {userRole === "volunteer" && ( // Show these links for volunteer user
                      <>
                          <Link to="/AllAnnounces" className="font-mono font-bold text-m text-white">All Announces</Link>
                          <Link to="/MyVolunteers" className="font-mono font-bold text-m text-white">My Volunteers</Link>
                          <Link to="/signin">
                              <svg className="w-7 h-7 text-white hover:text-red-600 duration-500 ml-16" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12H4m12 0-4 4m4-4-4-4m3-4h2a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3h-2"/>
                              </svg>
