        ...
        try {
            ...
            const response = await fetch('http://127.0.0.1:8000/api/application/create', {
                ...
                body: JSON.stringify({
                    ...
                    volunteer_id: userId // Include the user_id in the request body
                })
            });
            if (response.ok) {
        ...
        <div className="mt-16 px-10">
            ...
            <div className="flex flex-wrap gap-5 w-[80%] mx-auto mt-14">
                {annonces.map((annonce, index) => (
                    <div key={annonce.id} className=" w-[470px] max-w-2xl px-8 py-4 bg-white rounded-md shadow-lg border border-gray-200">
                        ...
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <div className="flex items-center">
                                <img className="hidden object-cover w-10 h-10 mx-4 rounded-full sm:block"
                                    ...
                                    alt="avatar" />
                                <p className="font-bold text-gray-700 cursor-pointer" tabIndex="0" role="link">{annonce.organiser_id}</p>
                            </div>
                        </div>
                    </div>
                ))}
